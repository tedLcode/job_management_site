...
const SearchBar: React.FC = () => {
  ...
  return (
    <div className="flex justify-center px-16 py-4">
      <form className="flex items-center gap-4 border shadow-[0_0_20px_rgba(127,127,127,0.15)] w-[890px] bg-white px-[26px] py-4 rounded-[122px] border-solid border-[#FCFCFC] max-md:flex-col max-md:w-full max-sm:p-4">
