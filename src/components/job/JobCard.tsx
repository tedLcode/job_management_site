...
const JobCard: React.FC<JobCardProps> = ({
  ...
  return (
    <div className="w-full shadow-[0_0_14px_rgba(211,211,211,0.15)] bg-white p-4 rounded-xl relative h-full flex flex-col">
      ...
      <p className="text-sm text-[#555] mb-5 flex-grow">{description}</p>
